...
export const Pricing: React.FC<PricingProps> = ({ ui, language, onStartFree, onStartPro, onStartBusiness }) => {
    return (
        <section className="py-16 px-4 bg-white dark:bg-black/20 border-t border-stone-line/30">
            <div className="max-w-6xl mx-auto">
                <div className="text-center mb-16 space-y-4">
                    <h2 className="text-3xl md:text-5xl font-serif font-bold text-brand-graphite leading-tight">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    {/* Free Tier */}
                    <div className="flex flex-col bg-brand-paper-accent rounded-3xl border border-stone-line p-8 shadow-sm transition-transform hover:-translate-y-1 duration-300">
                        <div className="flex items-center gap-3 mb-6">
                            <div className="w-10 h-10 rounded-xl bg-brand-clay/10 flex items-center justify-center text-brand-clay">
                                <Brain className="w-5 h-5" />
                            </div>
                            <h3 className="text-xl font-bold text-brand-graphite font-serif">
                    ...
                    <div className="flex flex-col bg-brand-paper-accent rounded-3xl border border-stone-line p-8 shadow-sm transition-transform hover:-translate-y-1 duration-300">
                        ...
                        <button 
                            ...
                            className="w-full py-4 px-6 bg-transparent border border-stone-line rounded-xl text-xs font-bold uppercase tracking-widest text-stone-400 hover:text-brand-graphite hover:bg-stone-bg transition-all"
                        >
                            Contact Sales
                        </button>
                    </div>
                ...
                <div className="mt-20 max-w-3xl mx-auto bg-stone-50 dark:bg-stone-900/40 rounded-3xl p-8 border border-stone-200 dark:border-stone-800">
                    <div className="flex items-center gap-3 mb-4">
                        ...
                        <h4 className="text-brand-graphite font-bold font-serif text-lg">
